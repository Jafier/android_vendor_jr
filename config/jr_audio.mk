#
# JafierRom Audio Files
#

ALARM_PATH := vendor/jr/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/jr/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/jr/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/jr/prebuilt/common/media/audio/ui
